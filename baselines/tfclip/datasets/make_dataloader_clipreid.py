...
from datasets.set.agreidvid import AGReIDVid
...
def make_dataloader(cfg):
	...
	if cfg.DATASETS.NAMES != 'mars' and cfg.DATASETS.NAMES != 'duke' and cfg.DATASETS.NAMES != 'lsvid' and cfg.DATASETS.NAMES != 'agreidvid':
		...
		if cfg.DATASETS.NAMES == 'agreidvid':
			dataset = __factory[cfg.DATASETS.NAMES](cfg, root=cfg.DATASETS.ROOT_DIR)
		else:
